            ...
            {!loading && !error && (
                <>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    {currentTab === 'centers' ? (
                                        ...
                                        <div className="flex space-x-3">
                                            {(currentTab === 'employees' || currentTab === 'equipment') && (
                                                <button
                                            ...
                                            >
                                                ...
                                                <span>Add {currentTab === 'employees' ? 'Employee' : currentTab === 'equipment' ? 'Equipment' : 'Center'}</span>
                                            </button>
                                        </div>
                                    )}
                                </div>
                    ...
                    <BulkUploadModal
                        ...
                        type={currentTab === 'employees' ? 'employee' : 'equipment'}
